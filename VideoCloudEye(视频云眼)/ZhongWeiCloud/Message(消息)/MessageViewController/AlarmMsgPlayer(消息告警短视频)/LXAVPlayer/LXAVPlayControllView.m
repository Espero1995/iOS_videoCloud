...
-(UILabel *)titleLabel{
    if (!_titleLabel) {
        _titleLabel =[UILabel LXLabelWithTextNoFrame:@"蝙蝠侠大战大灰狼" textColor:[UIColor hexStringToColor:@"ffffff"] backgroundColor:[UIColor clearColor] font:Font(18) textAlignment:NSTextAlignmentCenter];
    }
    return _titleLabel;
}
...
-(LXPlayLoadingView *)loadingView{
    if (!_loadingView) {
        _loadingView = [[LXPlayLoadingView alloc]initWithFrame:CGRectMake(0, 0, 45, 45) animationDuration:1.5 strokeColor:RGB(100, 200, 87)];
