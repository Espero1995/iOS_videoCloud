...
- (void)presentAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    //拿到button
    UIButton *button;
    for (UIView *subView in temp.view.subviews) {
        if ([subView isKindOfClass:[LoginButton class]]) {
...
- (void)dismissAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    for (UIView *subView in temp.view.subviews) {
        if ([subView isKindOfClass:[LoginButton class]]) {
            button = (UIButton *)subView;
//            CGRect frameBtn = button.frame;
//            frameBtn.origin.x = temp.view.center.x;
//            frameBtn.origin.y = 386;
//            button.frame = frameBtn;
    ...
    CGRect buttonFrame = {{iPhoneWidth/2-22,frame.origin.y},{44,44}};
