...
- (void)setUpUI:(CGRect)frame
{
    ...
    _shapeLayer.fillColor = [UIColor colorWithHexString:@"38adff"].CGColor;
...
-(void)loadingAnimation{
    ...
    _loadingLayer.strokeColor = [UIColor colorWithHexString:@"38adff"].CGColor;
    ...
    [self performSelector:@selector(removeAllAnimation) withObject:self afterDelay:1.5];
