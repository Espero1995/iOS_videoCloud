...
//    shrinkAnim.duration = _shrinkDuration;
    ...
    backgroundColor.toValue  = (__bridge id)MAIN_COLOR.CGColor;
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag {
    ...
    if ([cab.keyPath isEqualToString:@"position"]) {
        [NSTimer scheduledTimerWithTimeInterval:0.1f target:self selector:@selector(DidStopAnimationBackground) userInfo:nil repeats:nil];
    }
}
...
-(void)DidStopAnimationBackground {
