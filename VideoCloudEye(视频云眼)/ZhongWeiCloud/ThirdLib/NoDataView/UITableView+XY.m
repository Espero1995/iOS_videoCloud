...
//  GPS
//
//  Created by 高凌峰 on 2017/12/13.
//  Copyright © 2017年 苏旋律. All rights reserved.
//

#import "UITableView+XY.h"
#import "SXLNoDataView.h"
...
- (UIView *)xy_defaultNoDataViewWithImage:(UIImage *)image message:(NSString *)message color:(UIColor *)color offsetY:(CGFloat)offset {
    ...
    //  视图
    SXLNoDataView *view   = [[SXLNoDataView alloc] init];
...
- (void)freeNoDataViewIfNeeded {
    ...
    if ([self.backgroundView isKindOfClass:[SXLNoDataView class]]) {
