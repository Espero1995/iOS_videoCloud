...
- (void)addProgressSlider
{
    ...
    progressSlider.minimumTrackTintColor = [UIColor colorWithHexString:@"38adff"];
    progressSlider.maximumTrackTintColor = [UIColor clearColor];
    [progressSlider setThumbImage:[UIImage imageNamed:@"TYVideoPlayer.bundle/jindu"] forState:UIControlStateNormal];
