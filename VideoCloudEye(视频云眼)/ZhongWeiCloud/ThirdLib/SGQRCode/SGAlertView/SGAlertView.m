...
//    [self.coverView addTarget:self action:@selector(dismiss) forControlEvents:(UIControlEventTouchUpInside)];
    ...
    if (self.alertViewBottomViewType == SGAlertViewBottomViewTypeOne) {
        ...
        [_button setTitle:NSLocalizedString(@"确定", nil) forState:(UIControlStateNormal)];
        ...
        [_left_button setTitle:NSLocalizedString(@"取消", nil) forState:(UIControlStateNormal)];
        ...
        [_right_button setTitle:NSLocalizedString(@"确定", nil) forState:(UIControlStateNormal)];
