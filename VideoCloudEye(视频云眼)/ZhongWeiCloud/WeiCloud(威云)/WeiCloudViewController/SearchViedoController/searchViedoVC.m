...
- (void)setNavigationUI{
    ...
    self.searchBar.placeholder = NSLocalizedString(@"请输入设备名称", nil);
...
-(UITableView *)tv_list{
    if (!_tv_list) {
        ...
        [_tv_list registerNib:[UINib nibWithNibName:@"DeviceSearchCell" bundle:nil] forCellReuseIdentifier:WEIClOUDCELLT];
...
-(UILabel *)tipTitleLb{
    if (!_tipTitleLb) {
        ...
        _tipTitleLb.text = NSLocalizedString(@"最新设备", nil);
...
- (NSString *)xy_noDataViewMessage {
    return NSLocalizedString(@"未搜索到任何设备", nil);
}
