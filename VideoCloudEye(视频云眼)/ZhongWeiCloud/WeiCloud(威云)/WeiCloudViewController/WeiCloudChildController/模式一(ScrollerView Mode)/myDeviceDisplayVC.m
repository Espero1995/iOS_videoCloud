...
@implementation myDeviceDisplayVC
//=========================system=========================
- (void)viewDidLoad {
    [super viewDidLoad];
    //能力集合model初始化
...
- (void)loadPublicListData
{
    /*
    [self.dataArr removeAllObjects];
    NSArray * getCameraGroupModel = [unitl getCameraGroupModelIndex:0];
    NSMutableArray * getCameraGroupModel_Mutable = [NSMutableArray arrayWithCapacity:0];
    getCameraGroupModel_Mutable = (NSMutableArray *)getCameraGroupModel;
    self.dataArr = (NSMutableArray *)((deviceGroup *)getCameraGroupModel_Mutable).dev_list;
...
//    cell.ima_photo.image = [[JWcameraModelManger sharedJWcameraModelManger]getCameraDeviceConverImageIndex:indexPath.row];
