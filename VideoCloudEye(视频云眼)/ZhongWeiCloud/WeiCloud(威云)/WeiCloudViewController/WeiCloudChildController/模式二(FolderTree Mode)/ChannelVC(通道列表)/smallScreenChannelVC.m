...
#define SMALLCHANNELCELL @"smallScreenChannelCell"

#import "smallScreenChannelVC.h"
//========Model========
/*刷新的控件*/
...
/*告警消息列表*/
#import "AlarmMsgVC.h"
@interface smallScreenChannelVC ()
<
    UITableViewDelegate,
...
@implementation smallScreenChannelVC
//=========================system=========================
- (void)viewDidLoad {
    [super viewDidLoad];
    //能力集合model初始化
...
- (void)updataCutImageWithID:(NSNotification *)noti
{
    if (noti) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            smallScreenChannelCell *cell = [self.tv_list cellForRowAtIndexPath:index];
...
{
    smallScreenChannelCell *cell = [tableView dequeueReusableCellWithIdentifier:SMALLCHANNELCELL];
...
- (UITableView *)tv_list{
    if (!_tv_list) {
        ...
        [_tv_list registerNib:[UINib nibWithNibName:@"smallScreenChannelCell" bundle:nil] forCellReuseIdentifier:SMALLCHANNELCELL];
    }
    return _tv_list;
}
//数据源
